...
import { ED25519PublicKeyLen, ED25519PublicKey } from '@mailchain/crypto/browser/ed25519';
import { SECP256K1PublicKeyLength, SECP256K1PublicKey } from '@mailchain/crypto/browser/secp256k1/public';
...
function createV2IdentityKey(identityKeys) {
    return {
        ...
        apply: async (data) => {
            ...
            return {
                version: 2,
                messagePreview: preview.MessagePreview.create(Object.assign(Object.assign({}, data.messagePreview), { mailbox: result.identityKey.bytes })),
            };
        },
    };
}
function createV3EncodeIdentityKey() {
    return {
        ...
        apply: async (data) => {
            ...
            return {
                version: 3,
                messagePreview: preview.MessagePreview.create(Object.assign(Object.assign({}, messagePreview), { mailbox: encodePublicKey(mailboxIdentityKey) })),
            };
        },
    };
}
