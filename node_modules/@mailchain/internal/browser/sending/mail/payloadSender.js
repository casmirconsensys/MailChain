...
import { PayloadSender } from '../payload/send.js';
import { partitionMailchainResults } from '../../mailchainResult.js';

class SomePrepareDistributionError extends Error {
    constructor(successes, failures) {
        ...
        Object.defineProperty(this, "type", {
            ...
            configurable: true,
            writable: true,
            value: 'not_all_distribution_prepared'
        });
    }
}
...
export { MailPayloadSender, PayloadSendingError, SomePrepareDistributionError };
