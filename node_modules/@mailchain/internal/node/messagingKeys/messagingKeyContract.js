...
class MessagingKeyContractCall {
    ...
    static create(configuration, axiosInstance = axios.create()) {
        return new MessagingKeyContractCall(new Map([
            ...
            [addressing.ETHEREUM, mailchain.MailchainKeyRegContractCallResolver.create(configuration, axiosInstance)],
            [addressing.TEZOS, mailchain.MailchainKeyRegContractCallResolver.create(configuration, axiosInstance)],
            [protocols.MAILCHAIN, mailchain.MailchainKeyRegContractCallResolver.create(configuration, axiosInstance)],
