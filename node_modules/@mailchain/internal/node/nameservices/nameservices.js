...
class Nameservices {
    ...
    async reverseResolveNames(identityKey) {
        return this.identityKeysApi.getIdentityKeyResolvableNames(encoding.encodeHexZeroX(crypto.encodePublicKey(identityKey))).then(({ data }) => {
            var _a, _b;
            return (_b = (_a = data.resolvableNames) === null || _a === void 0 ? void 0 : _a.map((resolved) => (Object.assign(Object.assign({}, resolved), { address: addressing.createNameServiceAddress(resolved.name, resolved.resolver, this.mailchainAddressDomain) })))) !== null && _b !== void 0 ? _b : [];
        }, (e) => {
            console.error(e);
            return [];
        });
    ...
    async nameResolvesToMailbox(nsName, mailboxIdentityKey) {
        for (const nsDesc of nameservices.NAMESERVICE_DESCRIPTIONS) {
            ...
            if (addressIdentityKey != null && crypto.isPublicKeyEqual(addressIdentityKey.identityKey, mailboxIdentityKey)) {
                return nsAddress;
            }
        }
        return null;
