...
class SomeMailDeliveryRequestsFailedError extends Error {
    constructor(successes, failures) {
        ...
        Object.defineProperty(this, "type", {
            ...
            configurable: true,
            writable: true,
            value: 'not_all_mail_delivery_requests_sent'
        });
    }
}
class MailDeliveryRequests {
    ...
    async sendMailDeliveryRequests(params) {
        ...
        const sendResults = await Promise.all(distributions.map(async (preparedDistribution) => {
            ...
            const sendManyDeliveryRequestsParams = Object.assign({ recipients }, preparedDistribution.preparedPayload);
...
exports.SomeMailDeliveryRequestsFailedError = SomeMailDeliveryRequestsFailedError;
