...
function createMailerProofBuffer(mailerProof) {
    ...
    const canonicalized = canonicalize({
        params: {
            ...
            mailerMessagingKey: encoding.encodeHex(crypto.encodePublicKey(mailerProof.params.mailerMessagingKey)),
        },
...
function parseMailerProofFromJSON(content) {
    ...
    return {
        params: {
            ...
            mailerMessagingKey: crypto.decodePublicKey(encoding.decodeHex(rawRawMailerProof.params.mailerMessagingKey)),
