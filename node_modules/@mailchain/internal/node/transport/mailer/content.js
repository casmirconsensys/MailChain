...
function createContentBuffer(content) {
    ...
    const canonicalized = canonicalize({
        authorMessagingKey: encoding.encodeHex(crypto.encodePublicKey(content.authorMessagingKey)),
        ...
        mailerProof: {
            params: {
                ...
                mailerMessagingKey: encoding.encodeHex(crypto.encodePublicKey(content.mailerProof.params.mailerMessagingKey)),
            },
...
function parseMailerContentFromJSON(content) {
    ...
    const authorMessagingKey = crypto.decodePublicKey(encoding.decodeHex(rawMailerContent.authorMessagingKey));
    return {
        authorMessagingKey,
        ...
        mailerProof: {
            params: {
                ...
                mailerMessagingKey: crypto.decodePublicKey(encoding.decodeHex(rawMailerContent.mailerProof.params.mailerMessagingKey)),
