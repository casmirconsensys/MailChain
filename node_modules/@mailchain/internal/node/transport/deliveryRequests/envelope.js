...
async function createEnvelope(recipientMessagingKey, messageRootEncryptionKey, messageURI, rand = crypto.secureRandom) {
    ...
    const encryptedMessageKey = await encrypter.encrypt(crypto.encodePrivateKey(messageRootEncryptionKey.privateKey)); //TODO: look into encoding extended keys
    ...
    var errMsg = protocol.protocol.Envelope.verify(payload);
    if (errMsg)
        throw Error(errMsg);
