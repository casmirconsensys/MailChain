...
var nameservices = require('@mailchain/addressing/node/nameservices');
...
function createV2IdentityKey(identityKeys, mailchainAddressDomain) {
    return {
        ...
        apply: async ({ protoMailbox }) => {
            ...
            return {
                version: 2,
                protoMailbox: user.user.Mailbox.create(Object.assign(Object.assign({}, protoMailbox), { identityKey: crypto.encodePublicKey(result.identityKey) })),
            };
        },
    };
}
function createV3LabelMigration(mailchainAddressDomain) {
    return {
        ...
        apply: (data) => Promise.resolve({
            version: 3,
            protoMailbox: user.user.Mailbox.create(Object.assign(Object.assign({}, data.protoMailbox), { label: null })),
        }),
    };
}
    ...
    return {
        ...
        apply: (data) => {
            ...
            return Promise.resolve({
                version: 4,
                protoMailbox: user.user.Mailbox.create(Object.assign(Object.assign({}, protoMailbox), { aliases: [{ address, blockSending: false, blockReceiving: false }] })),
            });
        },
    };
}
function createV5NsMigration(nameservices) {
    return {
        ...
        apply: async ({ protoMailbox }) => {
            const identityKey = crypto.decodePublicKey(protoMailbox.identityKey);
            try {
                ...
                return { version: 5, protoMailbox: user.user.Mailbox.create(Object.assign(Object.assign({}, protoMailbox), { aliases })) };
            }
            catch (e) {
...
function createV6FixNsAliasFormatMigration(mailchainAddressDomain) {
    return {
        ...
        apply: (data) => {
            const aliases = data.protoMailbox.aliases.map((a) => {
                ...
                for (const nsDesc of nameservices.NAMESERVICE_DESCRIPTIONS) {
                    ...
                    if (matchingDomain != null) {
                        return user.user.Mailbox.Alias.create(Object.assign(Object.assign({}, a), { address: addressing.formatAddress(nsAddress, 'mail') }));
                    }
                }
            ...
            return Promise.resolve({
                version: 6,
                protoMailbox: user.user.Mailbox.create(Object.assign(Object.assign({}, data.protoMailbox), { aliases })),
            });
        },
    };
}
