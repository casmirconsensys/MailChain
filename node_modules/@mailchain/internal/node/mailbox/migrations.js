...
var ed25519 = require('@mailchain/crypto/node/ed25519');
var _public = require('@mailchain/crypto/node/secp256k1/public');
...
function createV2IdentityKey(identityKeys) {
    return {
        ...
        apply: async (data) => {
            ...
            return {
                version: 2,
                messagePreview: inbox.preview.MessagePreview.create(Object.assign(Object.assign({}, data.messagePreview), { mailbox: result.identityKey.bytes })),
            };
        },
    };
}
function createV3EncodeIdentityKey() {
    return {
        ...
        apply: async (data) => {
            ...
            return {
                version: 3,
                messagePreview: inbox.preview.MessagePreview.create(Object.assign(Object.assign({}, messagePreview), { mailbox: crypto.encodePublicKey(mailboxIdentityKey) })),
            };
        },
    };
}
