...
function publicKeyFromKind(kind, data) {
    switch (kind) {
        case keys.KindSECP256K1:
            return new _public$3.SECP256K1PublicKey(data);
        case keys.KindED25519:
            return new _public$2.ED25519PublicKey(data);
        case keys.KindSR25519:
            return new _public$1.SR25519PublicKey(data);
