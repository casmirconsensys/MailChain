...
class ED25519PrivateKey {
    ...
    static fromSeed(seed) {
        ...
        return new this(utilCrypto.ed25519PairFromSeed(seed, true));
    }
    static fromSecretKey(secretKey) {
        if (secretKey.length !== ED25519PrivateKeyLength) {
            throw Error('secret key must be 64 bytes');
        }
        return new this(utilCrypto.ed25519PairFromSecret(secretKey));
    }
    ...
    async sign(message) {
        return utilCrypto.ed25519Sign(message, this.keyPair);
    }
}
