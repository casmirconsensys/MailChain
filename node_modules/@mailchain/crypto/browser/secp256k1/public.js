import { publicKeyConvert, publicKeyVerify, ecdsaVerify } from 'secp256k1';
...
class SECP256K1PublicKey {
    ...
    async verify(message, sig) {
        ...
        const messageToVerify = Uint8Array.from(Buffer.from(hashMessage(Buffer.from(message)).replace('0x', ''), 'hex'));
        return ecdsaVerify(sig, messageToVerify, this.bytes);
    }
}

export { SECP256K1PublicKey, SECP256K1PublicKeyLength };
