...
function simpleV1enUS(encodedAddress, encodedMessagingPublicKey, nonce) {
    var lines = Array(11);
...
function mailchainUsername(encodedAddress, encodedMessagingPublicKey, nonce) {
    var lines = Array(4);
...
const templateMessageFunctions = new Map([
...
exports.mailchainUsername = mailchainUsername;
exports.simpleV1enUS = simpleV1enUS;
