...
function simpleHardFold(str, opts) {
    ...
    let finalContentLength = opts.lineLength - ((_b = (_a = opts.prefix) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) - ((_d = (_c = opts.suffix) === null || _c === void 0 ? void 0 : _c.length) !== null && _d !== void 0 ? _d : 0);
    finalContentLength =
    ...
    for (let i = 0; i < numFoldedLines; i++) {
        ...
        folded += `${(_e = opts.prefix) !== null && _e !== void 0 ? _e : ''}${foldPart}${(_f = opts.suffix) !== null && _f !== void 0 ? _f : ''}`;
        if (i + 1 < numFoldedLines) {
            folded += consts.CRLF; // don't put CRLF on last line
        }
    }
    return folded;
}
...
function contentAppendWithFolding(content, appendParts, lineLength) {
    const contentLines = content.split(consts.CRLF);
    for (const part of appendParts) {
        ...
        if (lastLine.length === 0 || lastLine.length + part.length < lineLength) {
            ...
            contentLines.push(consts.HTAB + part);
        }
    }
    return contentLines.join(consts.CRLF);
}

exports.contentAppendWithFolding = contentAppendWithFolding;
exports.semanticLineFold = semanticLineFold;
exports.simpleHardFold = simpleHardFold;
