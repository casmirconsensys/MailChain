 ...
 */
export declare function exportDateHeader(header: DateHeader, ctx: MessageComposerContext): Promise<string>;
/**
 ...
 * ```
 */
export declare function exportAddressHeader(header: AddressHeader, ctx: MessageComposerContext): Promise<string>;
export declare function exportMessageIdHeader(header: MessageIdsHeader, ctx: MessageComposerContext): Promise<string>;
