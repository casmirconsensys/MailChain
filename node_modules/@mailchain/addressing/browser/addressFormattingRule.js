import { isMailchainAccountAddress, isNearImplicitAccount, isTezosAddress, isEthereumAddress } from './addressPredicates.js';
import { decodeAddressByProtocol } from './encoding.js';
import { formatMailLike } from './formatMailLike.js';
import { matchesNameservice } from './nameservices/matchesNameservice.js';
import { NAMESERVICE_DESCRIPTIONS } from './nameservices/nameserviceDescriptions.js';
import { parseWalletAddress } from './parseWalletAddress.js';
import { NEAR, TEZOS, ETHEREUM } from './protocols/consts.js';
...
const humanNearAddress = (address) => {
    ...
    if (usernameParts.length <= 2 &&
        ...
        return formatMailLike([`${usernameParts[0].slice(0, 6)}...${usernameParts[0].slice(-4)}`, ...usernameParts.slice(1)].join('.'), props.protocol);
    }
    if (usernameParts[usernameParts.length - 1] === NEAR)
...
export { humanNameServiceFormatters };
