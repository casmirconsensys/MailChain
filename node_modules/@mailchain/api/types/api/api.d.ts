 ...
 */
import type { Configuration } from '@mailchain/api/types/api/configuration';
import type { AxiosPromise, AxiosInstance, AxiosRequestConfig } from 'axios';
import type { RequestArgs } from '@mailchain/api/types/api/base';
import { BaseAPI } from '@mailchain/api/types/api/base';
/**
 *
 * @export
...
export declare const IdentityKeysApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @param {'ethereum' | 'near' | 'tezos'} Protocol Protocol where address is looked up.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getIdentityKey: (Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const IdentityKeysApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getIdentityKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetIdentityKeyResponseBody>>;
    /**
     * Calculates all addresses for supported protocols. Then checks to see if vended messaging keys have been created. Only returns addresses that have vended messaging keys.
     * @summary Gets all for an address for an identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare const IdentityKeysApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getIdentityKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: any): AxiosPromise<GetIdentityKeyResponseBody>;
    /**
     * Calculates all addresses for supported protocols. Then checks to see if vended messaging keys have been created. Only returns addresses that have vended messaging keys.
     * @summary Gets all for an address for an identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export interface IdentityKeysApiInterface {
     ...
     */
    getIdentityKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): AxiosPromise<GetIdentityKeyResponseBody>;
    /**
     * Calculates all addresses for supported protocols. Then checks to see if vended messaging keys have been created. Only returns addresses that have vended messaging keys.
     * @summary Gets all for an address for an identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare class IdentityKeysApi extends BaseAPI implements IdentityKeysApiInterface {
     ...
     */
    getIdentityKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetIdentityKeyResponseBody, any>>;
    /**
     * Calculates all addresses for supported protocols. Then checks to see if vended messaging keys have been created. Only returns addresses that have vended messaging keys.
     * @summary Gets all for an address for an identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare const MessagingKeysApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getProtocolAddressNonce: (Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVendedPrivateMessagingKey: (Address: string, Protocol: 'ethereum' | 'near' | 'tezos', IdentityKey: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getVendedPublicMessagingKey: (Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Only address owners can change an address\'s messaging key. Owner\'s need to sign a message that includes the new messaging key and nonce.
     * @summary Upload a messaging key for an address\'s identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare const MessagingKeysApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getProtocolAddressNonce(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetProtocolAddressNonceResponseBody>>;
    /**
     * First it looks up the identity key for the address to see if a user has registered a messaging key for the blockchain address. If a key is not registered it will return a Mailchain vended messaging key. Note: this will only return the vended messaging for owners of the address.
     * @summary Get\'s the private messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @throws {RequiredError}
     */
    getVendedPrivateMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', IdentityKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetVendedPrivateMessagingKeyResponseBody>>;
    /**
     * First it looks up the identity key for the address to see if a user has registered that the public key. In this case it will vend messaging key for the identity key. Otherwise it will vend a messaging key for the blockchain address.
     * @summary Get\'s the public messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @throws {RequiredError}
     */
    getVendedPublicMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetMessagingKeyResponseBody>>;
    /**
     * Only address owners can change an address\'s messaging key. Owner\'s need to sign a message that includes the new messaging key and nonce.
     * @summary Upload a messaging key for an address\'s identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare const MessagingKeysApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getProtocolAddressNonce(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: any): AxiosPromise<GetProtocolAddressNonceResponseBody>;
    /**
     * First it looks up the identity key for the address to see if a user has registered a messaging key for the blockchain address. If a key is not registered it will return a Mailchain vended messaging key. Note: this will only return the vended messaging for owners of the address.
     * @summary Get\'s the private messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @throws {RequiredError}
     */
    getVendedPrivateMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', IdentityKey: string, options?: any): AxiosPromise<GetVendedPrivateMessagingKeyResponseBody>;
    /**
     * First it looks up the identity key for the address to see if a user has registered that the public key. In this case it will vend messaging key for the identity key. Otherwise it will vend a messaging key for the blockchain address.
     * @summary Get\'s the public messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @throws {RequiredError}
     */
    getVendedPublicMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: any): AxiosPromise<GetMessagingKeyResponseBody>;
    /**
     * Only address owners can change an address\'s messaging key. Owner\'s need to sign a message that includes the new messaging key and nonce.
     * @summary Upload a messaging key for an address\'s identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export interface MessagingKeysApiInterface {
     ...
     * @memberof MessagingKeysApiInterface
     */
    getProtocolAddressNonce(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): AxiosPromise<GetProtocolAddressNonceResponseBody>;
    /**
     * First it looks up the identity key for the address to see if a user has registered a messaging key for the blockchain address. If a key is not registered it will return a Mailchain vended messaging key. Note: this will only return the vended messaging for owners of the address.
     * @summary Get\'s the private messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @memberof MessagingKeysApiInterface
     */
    getVendedPrivateMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', IdentityKey: string, options?: AxiosRequestConfig): AxiosPromise<GetVendedPrivateMessagingKeyResponseBody>;
    /**
     * First it looks up the identity key for the address to see if a user has registered that the public key. In this case it will vend messaging key for the identity key. Otherwise it will vend a messaging key for the blockchain address.
     * @summary Get\'s the public messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @memberof MessagingKeysApiInterface
     */
    getVendedPublicMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): AxiosPromise<GetMessagingKeyResponseBody>;
    /**
     * Only address owners can change an address\'s messaging key. Owner\'s need to sign a message that includes the new messaging key and nonce.
     * @summary Upload a messaging key for an address\'s identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
...
export declare class MessagingKeysApi extends BaseAPI implements MessagingKeysApiInterface {
     ...
     * @memberof MessagingKeysApi
     */
    getProtocolAddressNonce(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetProtocolAddressNonceResponseBody, any>>;
    /**
     * First it looks up the identity key for the address to see if a user has registered a messaging key for the blockchain address. If a key is not registered it will return a Mailchain vended messaging key. Note: this will only return the vended messaging for owners of the address.
     * @summary Get\'s the private messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @memberof MessagingKeysApi
     */
    getVendedPrivateMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', IdentityKey: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetVendedPrivateMessagingKeyResponseBody, any>>;
    /**
     * First it looks up the identity key for the address to see if a user has registered that the public key. In this case it will vend messaging key for the identity key. Otherwise it will vend a messaging key for the blockchain address.
     * @summary Get\'s the public messaging key for a blockchain address.
     * @param {string} Address Address to look for encoded based on the protocol standard.
     ...
     * @memberof MessagingKeysApi
     */
    getVendedPublicMessagingKey(Address: string, Protocol: 'ethereum' | 'near' | 'tezos', options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetMessagingKeyResponseBody, any>>;
    /**
     * Only address owners can change an address\'s messaging key. Owner\'s need to sign a message that includes the new messaging key and nonce.
     * @summary Upload a messaging key for an address\'s identity key.
     * @param {string} IdentityKey Blockchain identity key encoded as a descriptive public key.
