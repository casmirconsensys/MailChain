import { SR25519PublicKey, SECP256K1PublicKey, ED25519PublicKey, SR25519PrivateKey, SECP256K1PrivateKey, ED25519PrivateKey } from '@mailchain/crypto';
import { decode } from '@mailchain/encoding';
import { SECP256R1PublicKey, SECP256R1PrivateKey } from '@mailchain/crypto/browser/secp256r1';
