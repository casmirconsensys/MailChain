...
const getToken = async (requestKey, payload, exp) => {
    ...
    const payloadSegment = encodeBase64UrlSafe(Buffer.from(JSON.stringify(Object.assign(Object.assign({}, payload), { exp }))));
...
const getAxiosWithSigner = (requestKey) => {
    ...
    axiosInstance.interceptors.request.use(async (request) => {
        ...
        if (request.headers) {
            ...
            const tokenPayload = createTokenPayload(new URL((_a = request === null || request === void 0 ? void 0 : request.url) !== null && _a !== void 0 ? _a : ''), (_c = (_b = request.method) === null || _b === void 0 ? void 0 : _b.toUpperCase()) !== null && _c !== void 0 ? _c : '', request.data);
...
export { createTokenPayload, getAxiosWithSigner, getToken };
