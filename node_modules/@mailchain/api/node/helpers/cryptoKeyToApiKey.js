...
function convertPublic(key) {
    switch (key.curve) {
        ...
        case crypto.KindSR25519:
            return { curve: api.PublicKeyCurveEnum.Sr25519, value: encoding.encodeHexZeroX(key.bytes), encoding: 'hex/0x-prefix' };
...
function convertPrivate(key) {
    switch (key.curve) {
        ...
        case crypto.KindSR25519:
            return { curve: api.PrivateKeyCurveEnum.Sr25519, value: encoding.encodeHexZeroX(key.bytes), encoding: 'hex/0x-prefix' };
        case crypto.KindSECP256R1:
            return {
