...
var secp256r1 = require('@mailchain/crypto/node/secp256r1');
...
function convertPublic(key) {
    switch (key.curve) {
        ...
        case api.PrivateKeyCurveEnum.Sr25519:
            return new crypto.SR25519PublicKey(encoding.decode(key.encoding, key.value));
...
function convertPrivate(key) {
    switch (key.curve) {
        ...
        case api.PrivateKeyCurveEnum.Sr25519:
            return crypto.SR25519PrivateKey.fromBytes(encoding.decode(key.encoding, key.value));
